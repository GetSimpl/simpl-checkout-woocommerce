...
{
    // return (
    //     'yes' == get_option('woocommerce_simpl_settings')['enable_debug_mode']
    // );
    return true;
}
 ...
 * @param string $message Message to log.
 */
function simpl_log_emergency($message)
{
 ...
 * @param string $message Message to log.
 */
function simpl_log_alert($message)
{
 ...
 * @param string $message Message to log.
 */
function simpl_log_critical($message)
{
 ...
 * @param string $message Message to log.
 */
function simpl_log_error($message)
{
 ...
 * @param string $message Message to log.
 */
function simpl_log_warning($message)
{
 ...
 * @param string $message Message to log.
 */
function simpl_log_notice($message)
{
 ...
 * @param string $message Message to log.
 */
function simpl_log_info($message)
{
 ...
 * @param string $message Message to log
 */
function simpl_log_debug($message)
{
