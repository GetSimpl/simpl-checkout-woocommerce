...
function simpl_checkout_int() {
    ...
    define('WIDGET_SCRIPT_STAGING_URL', 'https://res.cloudinary.com/dlkxxfbi9/raw/upload/v1679656308/script/simpl-checkout-woocommerce-widget.iife_f0cqa0.js');
    define('WIDGET_SCRIPT_PRODUCTION_URL', 'https://res.cloudinary.com/dlkxxfbi9/raw/upload/v1679656308/script/simpl-checkout-woocommerce-widget.iife_f0cqa0.js');
