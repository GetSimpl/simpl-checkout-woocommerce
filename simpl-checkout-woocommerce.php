...
function simpl_checkout_int() {
    ...
    define('WIDGET_SCRIPT_STAGING_URL', 'https://s3.ap-southeast-1.amazonaws.com/staging-cdn.getsimpl.com/widget-script-v2/woocommerce/temp/simpl-checkout-woocommerce-widget.iife.js');
