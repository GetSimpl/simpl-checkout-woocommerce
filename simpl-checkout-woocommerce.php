...
if ( ! class_exists( 'simpl_checkout_int' ) ) {
    ...
    function simpl_checkout_int() {
        ...
        register_activation_hook( __FILE__, 'simpl_checkout_plugin_activate' );
        register_deactivation_hook( __FILE__, 'simpl_checkout_plugin_deactivate' );
    }
}
